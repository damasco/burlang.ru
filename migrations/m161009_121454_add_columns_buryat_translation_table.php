...
class m161009_121454_add_columns_buryat_translation_table extends Migration
{
    /**
     * @var string
     */
    protected $tableName = '{{%buryat_translation}}';

    /**
     * @var string
     */
    protected $fkNameCreatedBy = 'fk-buryat_translation-created_by-user-id';

    /**
     * @var string
     */
    protected $fkNameUpdatedBy = 'fk-buryat_translation-updated_by-user-id';
