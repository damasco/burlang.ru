...
class m161009_040813_add_columns_russian_word_table extends Migration
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $fkNameCreatedBy = 'fk-russian_word-created_by-user-id';

    /**
     * @var string
     */
    protected $fkNameUpdatedBy = 'fk-russian_word-updated_by-user-id';
